...
<body>
    ...
    <nav class="nav">
        <ul class="nav__list">
            ...
            <li class="nav_about">
                <a href="aboutUs.html" class="nav__link active_link">About</a>
            </li>
            <li class="user_icon">
    ...
    if ($resultCheck > 0){
        while($row = mysqli_fetch_assoc($result)){?>
                  ...
                  <form method="post" action="removeproduct.php">
                    ...
                    <td class="text-center align-middle px-0"><input value="x" name="remove" type="submit"></td>
                   </form>
                  </tr>
...
<br /><br />
            ...
            <div class="btner-group">
                ...
                <a href="checkout.html" ><button class="buttoning">Checkout</button></a>
            </div>
